...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            powershell.AddScript(GetScript(VMName, VMSize, VMBus, VMLun))
        ...
        Function GetScript(VMName As String, VMSize As String, VMBus As String, VMLun As String) As String

            Dim sw As New StringWriter

            sw.WriteLine("$VM = Get-SCVirtualMachine -Name " + Chr(34) + VMName + Chr(34))

            sw.WriteLine("$VirtDiskDrive = Get-SCVirtualDiskDrive -VM $VM | where {$_.Bus -eq " + VMBus + " -and $_.Lun -eq " + VMLun + "}")

            sw.WriteLine("Expand-SCVirtualDiskDrive -VirtualDiskDrive $VirtDiskDrive -VirtualHardDiskSizeGB " + VMSize)
