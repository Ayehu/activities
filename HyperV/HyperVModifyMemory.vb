...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public NewMemorySizeMB As String
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            If SCVMM = "1" Then
                powershell.AddScript(GetScript(VMName, NewMemorySizeMB))
            Else
                Dim sw2 As New StringWriter
                sw2.WriteLine("Set-VM -StaticMemory -Name " + Chr(34) + VMName + Chr(34) + "-MemoryStartupBytes " + NewMemorySizeMB + "MB")
        ...
        Function GetScript(VMName As String, NewMemorySizeMB As String) As String
            ...
            sw.WriteLine("Set-SCVirtualMachine -VM $VM -MemoryMB " + NewMemorySizeMB)
