...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public VMHA As String
        Public SCVMM As String
        Public VMNewName As String
        Public VMPath As String
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            powershell.AddScript(GetScript(VMName, VMTemplateName, VMHA, VMNewName, VMPath))
        ...
        End Function
        Function GetScript(VMName As String, VMTemplateName As String, VMHA As String, VMNewName As String, VMPath As String) As String
            Dim sw As New StringWriter

            sw.WriteLine("$VMTemplate = Get-SCVMTemplate -Name " + Chr(34) + VMTemplateName + Chr(34))
            sw.WriteLine("$VMHost = Get-SCVMHost -ComputerName " + Chr(34) + VMName + Chr(34))

            sw.WriteLine("New-SCVirtualMachine -VMTemplate $VMTemplate -Name " + Chr(34) + VMNewName + Chr(34) + " -VMHost $VMHost -Path " + Chr(34) + VMPath + Chr(34) + " -HighlyAvailable $" & VMHA)
