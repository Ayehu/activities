...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            powershell.AddScript(GetScript(VMName, CPUCount))
        ...
        Function GetScript(VMName As String, CPUCount As String) As String
            ...
            sw.WriteLine("Set-SCVirtualMachine -VM $VM -CPUCount " + CPUCount)
