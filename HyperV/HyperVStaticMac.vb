...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            powershell.AddScript(GetScript(VMName, MACADDR))
        ...
        Function GetScript(VMName As String, MACADDR As String) As String
            ...
            sw.WriteLine("Set-SCVirtualNetworkAdapter -VirtualNetworkAdapter (Get-VirtualNetworkAdapter -VM $VM) -MACAddressType " + chr(34) + "Static" + chr(34) + " -MACAddress " + chr(34) + MACADDR + chr(34))
