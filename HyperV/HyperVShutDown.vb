...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            If SCVMM = "1" Then
                sw2.WriteLine("$VM = Get-SCVirtualMachine -Name " + Chr(34) + VMName + Chr(34) + " -VMMServer " + HostName)
                sw2.WriteLine("Stop-SCVirtualMachine -VM $VM –Shutdown")
            Else
                'Force argument bypass this error:
                'A Command that prompts the user failed because the host program Or the command type does Not support user interaction.
                'Added -Force = Hyper-V gives the guest five minutes to save data, then forces a shutdown. This shutdown can result in loss of unsaved data.
                sw2.WriteLine("Stop-VM -Force -VMName " + Chr(34) + VMName + Chr(34))
            End If
