...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public VMVHDPath As String
        Public VMVHDTemplatePath As String
        Public VMDiskSize As String
        Public VMStaticMemorySize As String
        Public VMSwitchName As String
        Public VMProcessors As String
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            Dim execmd As String = "New-VM -Name '" & VMName & "' -VHDPath (New-VHD -Differencing -ParentPath '" & VMVHDTemplatePath & "' -Path '" & VMVHDPath & "' -SizeBytes " & VMDiskSize & ").Path -MemoryStartupBytes " & VMStaticMemorySize & " -SwitchName '" & VMSwitchName & "' | Set-VM -ProcessorCount " & VMProcessors & " -Passthru | Start-VM -Passthru "

            sw2.WriteLine(execmd)
