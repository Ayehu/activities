    ...
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            Try
                ...
                End If
                CanCreate = Not IISSchema.Properties("Syntax").Value.ToString.ToUpper() = "BOOLEAN"
                IISSchema.Dispose()
                ...
                If CanCreate Then
                    ...
                    Dim VDir As System.DirectoryServices.DirectoryEntry = IISAdmin.Children.Find(VDName, "IIsWebVirtualDir")
                    ...
                    dt.Rows.Add("Success")
                Else
                    Throw New Exception("Error updating virtual directory")
                End If
