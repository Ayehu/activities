...
Namespace Ayehu.Sdk.ActivityCreation
  Public Class ActivityClass
      ...
      Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
          ...
          Try
          ticks = results.Properties("lockoutTime")(0)
          Catch
          End Try
          isLocked = ISAccountLocked(dey)
          If (isLocked = True) OrElse (ticks > 0) Then
          dt.Rows.Add("True")
          dey.Close()
          Else
          dt.Rows.Add("False")
          ...
          End If
          Else
          dt.Rows.Add(ISAccountLocked(de))
          End If
 ...
 Return Me.GenerateActivityResult(dt)
          ...
          Function ISAccountLocked(ByVal de As DirectoryEntry) As Boolean
