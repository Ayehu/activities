  ...
  Public HostName As String
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
           ...
           dt.Columns.Add("Result", GetType(String))
            ...
            If String.IsNullOrEmpty(SecurePort) = True Then SecurePort = DefaultAdPort

            If IsNumeric(SecurePort) = False Then Throw New ApplicationException("Port parameter must be number")
