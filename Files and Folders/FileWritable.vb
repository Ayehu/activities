...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            dt.Columns.Add("Writable", GetType(String))
            ...
            If Path.StartsWith("\\") Then
                ...
                For Each oReturn As FileInfo In Files
                    Try
                        If ValidateFile(LCase(FileName), LCase(FileNameExtension), LCase(oReturn.FullName)) = True Then
                            Fnd = True
                            If oReturn.IsReadOnly = True Then
                                dt.Rows.Add(oReturn.Name, "False")
                            Else
                                dt.Rows.Add(oReturn.Name, "True")
                            End If
                ...
                ElseIf dt.Rows.Count = 1 Then
                    Dim f As String = dt.Rows(0)("Writable")
            ...
            Else
                ...
                Dim oQuery As ObjectQuery = New System.Management.ObjectQuery("SELECT Name , Writeable , FileName  , Extension  FROM CIM_DataFile WHERE Drive = '" & Volume.Replace("\", "") & "' and path = '" & PathOnlyNoVolume & "'")
                ...
                For Each oReturn As ManagementObject In oSearcher.Get()
                    If ValidateFile(lcase(FileName), lcase(FileNameExtension), lcase(oReturn("Name"))) = True Then
                        Fnd = True
                        If oReturn("Writeable") = True Then
                            dt.Rows.Add(oReturn("FileName") & "." & oReturn("Extension"), "True")
                        Else
                            dt.Rows.Add(oReturn("FileName") & "." & oReturn("Extension"), "False")
                        End If
