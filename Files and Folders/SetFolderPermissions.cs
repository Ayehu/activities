...
namespace Ayehu.Sdk.ActivityCreation
{
    public class ActivityClass : IActivity
    {
        ...
        public void AddAccessRule(DirectorySecurity fs, SecurityIdentifier si, string[] singleUserData, FileSystemRights Rights, InheritanceFlags iFlags)
        {
            ...
            if (bool.Parse(singleUserData[1]))
            {
                ...
                //add current user with full control.
                Rights = FileSystemRights.FullControl;
                fs.AddAccessRule(new FileSystemAccessRule(si, Rights, iFlags, PropagationFlags.None, AccessControlType.Allow));
                //fs.AddAccessRule(new FileSystemAccessRule(UsrName, FileSystemRights.FullControl, AccessControlType.Allow));
            }
            else
            {
        ...
        {
            // Create a new ACE for the descriptor.
            ManagementObject newAce = new ManagementClass(oms,
            ...
            newAce.Properties["AceFlags"].Value = AceFlags.ContainerInherit | AceFlags.ObjectInherit | AceFlags.NoPropagateInherit;
