...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            dt.Columns.Add("AccessedDate", GetType(String))
            ...
            If Path.StartsWith("\\") Then
                ...
                For Each oReturn As FileInfo In Files
                    Try
                        If ValidateFile(LCase(FileName), LCase(FileNameExtension), LCase(oReturn.FullName)) = True Then
                            Fnd = True
                            dt.Rows.Add(oReturn.Name, oReturn.LastAccessTime)
                        End If
                    Catch
                    End Try
                Next
                ...
                ElseIf dt.Rows.Count = 1 Then
                    Dim f As String = dt.Rows(0)("AccessedDate")
            ...
            Else
                ...
                Dim oQuery As ObjectQuery = New System.Management.ObjectQuery("SELECT Name , LastAccessed , FileName  , Extension  FROM CIM_DataFile WHERE Drive = '" & Volume.Replace("\", "") & "' and path = '" & PathOnlyNoVolume & "'")
                ...
                For Each oReturn As ManagementObject In oSearcher.Get()
                    If ValidateFile(lcase(FileName), lcase(FileNameExtension), lcase(oReturn("Name"))) = True Then
                        Fnd = True
                        wd = oReturn("LastAccessed")
                        dt.Rows.Add(oReturn("FileName") & "." & oReturn("Extension"), DateSerial(Left(wd, 4), Mid(wd, 5, 2), Mid(wd, 7, 2)) & " " & TimeSerial(Mid(wd, 9, 2), Mid(wd, 11, 2), Mid(wd, 13, 2)))
                    End If
                Next
