...
Namespace Ayehu.Sdk.ActivityCreation
    Public Class ActivityClass
        ...
        Public Function Execute() As ICustomActivityResult Implements IActivity.Execute
            ...
            dt.Columns.Add("CreationDate", GetType(String))
            ...
            If Path.StartsWith("\\") Then
                ...
                For Each oReturn As FileInfo In Files
                    Try
                        If ValidateFile(LCase(FileName), LCase(FileNameExtension), LCase(oReturn.FullName)) = True Then
                            Fnd = True
                            dt.Rows.Add(oReturn.Name, oReturn.CreationTime)
                        End If
                    Catch
                    End Try
                Next
                ...
                ElseIf dt.Rows.Count = 1 Then
                    Dim f As String = dt.Rows(0)("CreationDate")
            ...
            Else
                ...
                Dim oQuery As ObjectQuery = New System.Management.ObjectQuery("SELECT Name , CreationDate , FileName  , Extension  FROM CIM_DataFile WHERE Drive = '" & Volume.Replace("\", "") & "' and path = '" & PathOnlyNoVolume & "'")
