...
namespace Ayehu.Sdk.ActivityCreation
{
    public class ActivityClass : IActivity
    {
        ...
        public string MemoryStateDump;
        public string PauseDiskWrites;
...

        {
            ...
            dtParams.Columns.Add("SnapshotName");
            dtParams.Columns.Add("SnapshotDescription");
            dtParams.Columns.Add("MemoryStateDump");
            dtParams.Columns.Add("PauseDiskWrites");

            DataRow rParams = dtParams.NewRow();
            rParams["Command"] = "VMCreateSnapshot";
            rParams["UserName"] = UserName;
            rParams["Password"] = Password;
            rParams["HostName"] = HostName;
            rParams["VMName"] = VMName;
            rParams["SnapshotName"] = SnapshotName;
            rParams["SnapshotDescription"] = SnapshotDescription;
            rParams["MemoryStateDump"] = MemoryStateDump;
            rParams["PauseDiskWrites"] = PauseDiskWrites;
