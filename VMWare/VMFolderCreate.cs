...
namespace Ayehu.Sdk.ActivityCreation
{
    public class ActivityClass : IActivity
    {
...

        {
            ...
            dtParams.Columns.Add("ParentFolder");
            dtParams.Columns.Add("NewFolder");

            DataRow rParams = dtParams.NewRow();
            rParams["Command"] = "VMFolderCreate";
            rParams["UserName"] = UserName;
            rParams["Password"] = Password;
            rParams["HostName"] = HostName;
            rParams["ParentFolder"] = ParentFolder;
            rParams["NewFolder"] = NewFolder;
