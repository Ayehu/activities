...
namespace Ayehu.Sdk.ActivityCreation
{
    public class ActivityClass : IActivity
    {
...

        {
            ...
            //string command_path = "C:\\cage\\vmrunner\\bin\\Debug\\VMWare.exe";
            ...
            dtParams.Columns.Add("DeleteChildren");


            DataRow rParams = dtParams.NewRow();
            rParams["Command"] = "VMDeleteSnapshot";
            ...
            rParams["DeleteChildren"] = DeleteChildren;
